...
func init() {
	...
	flag.StringVar(&options.Env.LocalPrefix, "local", "", "put imports beginning with this string after private packages; comma-separated list")
	flag.StringVar(&options.Env.PrivatePrefix, "private", "", "put imports beginning with this string after 3rd-party packages; comma-separated list")
